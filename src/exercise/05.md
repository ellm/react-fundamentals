...
- Learned about `style` being a combination of a JSX
expression and object expression.
- Learned about `props.children`
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=05%3A%20Styling&em=matt.ell%40alley.co).
